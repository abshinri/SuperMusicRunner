...
func _physics_process(_delta: float) -> void:
	...
	pass
func _generate_tween(_target, _y:=- 24, _duration:=.16) -> bool:
	var tween = create_tween()
	tween.tween_property(_target, "position", position + Vector2(0, _y), _duration)
...
func _generate_coin() -> void:
	...
	await _generate_tween(coin, -16, 0.1)
